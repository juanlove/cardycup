...
const [banlist1, setBanList1] = createStore<GenshinCharacter['id'][]>(Array.from({length: 3}))
const [banlist2, setBanList2] = createStore<GenshinCharacter['id'][]>(Array.from({length: 3}))
